...
Programación & Modelado: Python (pandas, numpy, feature engineering).

Bases de Datos: SQL (Extracción, manipulación y optimización de consultas para grandes volúmenes de datos transaccionales).

Inteligencia de Negocios (BI): Creación de dashboards y Medidas DAX para monitorear KPIs críticos de proyectos (Curva S, CPI/SPI, Variación de Costos).

Análisis Avanzado: Análisis estadístico, Data Storytelling y Cuantificación de Riesgos.
...
Mis años como Analista de Costos y Gestor de Contratos en Infraestructura me enseñaron a preguntar lo correcto y a comprender las consecuencias reales de una desviación presupuestal. Esto me permite ir más allá del código para ofrecer soluciones que:

Reducen el Riesgo: Identificando tendencias y anomalías en el dato de proyecto.
...
¡Siempre abierto a colaborar en retos de datos que involucren infraestructura, optimización y crecimiento!
